...
int main(int argc, char **argv)
{
    ...
    for(int ni=0; ni<nImages; ni++)
    {
        ...
        // im = cv::imread(string(argv[3])+"/"+vstrImageFilenames[ni], CV_LOAD_IMAGE_UNCHANGED); // OpenCV < 4.x
        im = cv::imread(string(argv[3])+"/"+vstrImageFilenames[ni], cv::IMREAD_UNCHANGED); // OpenCV == 4.x
